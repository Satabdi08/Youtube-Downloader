...
root.iconbitmap("C:/Users/SATABDI/Desktop/Projects/YouTube.ico")
...
canvas.create_image(350,60,image=logo)

tab1=Frame(root,width=800,height=800)
...
try:
  os.mkdir(path)
  os.mkdir("D:/Youtube Downloader/Video")
  os.mkdir("D:/Youtube Downloader/Audio")
...
def download():
  ...
  if VIDEO==TRUE:
    ...
    os.chdir("D:/Youtube Downloader/Video")
    try:
  ...
  if AUDIO==TRUE:
    ...
    my_progress.stop()
    label2.grid(row=9,column=1)
    os.chdir("D:/Youtube Downloader/Audio")
    try:
